    ...
    <div className=" w-full md:w-1/3 bg-white border-2 border-lightText md:border-none p-5 rounded-lg shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
      <div>
        <p className=" text-lightText">
          I like this chicken. its givin me goosebumps. Ehhh i wish i could make such for my friends so that they can praise me. But myeeeeeeeeee i will make sure i continue supporting you guy. 
        </p>
      </div>
